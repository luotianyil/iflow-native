...
namespace iflow\native\Window\NetChannel\WebSocket\Formatter;
...
class PackageFormatter {
    ...
    public static function message(string $payload, int $offset = 1, string $nsp = '/'): string {
    ...
    public static function decode(string $str): PackageFormatter {
        $i = 0;
        $packet = new PackageFormatter((int) substr($str, 0, 1));
        if ('/' === substr($str, $i + 1, 1)) {
